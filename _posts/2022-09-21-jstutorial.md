...
nb_path: _notebooks/2022-09-21-jstutorial.ipynb
layout: notebook
---
...
#################################################
# file to edit: _notebooks/2022-09-21-jstutorial.ipynb
-->
...
<div class=" highlight hl-javascript"><pre><span></span><span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="s2">&quot;Hello Kaylee&quot;</span><span class="p">);</span> <span class="c1">// this is like the print function in python</span>
</pre></div>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-javascript"><pre><span></span><span class="kd">var</span> <span class="nx">msg</span> <span class="o">=</span> <span class="s2">&quot;Hello, Kaylee!&quot;</span><span class="p">;</span>  <span class="c1">// variable name is msg, set variable equal to string</span>
<span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="nx">msg</span><span class="p">);</span>   <span class="c1">// print variable, which prints string</span>
</pre></div>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-javascript"><pre><span></span><span class="kd">function</span> <span class="nx">logIt</span><span class="p">(</span><span class="nx">answer</span><span class="p">)</span> <span class="p">{</span>   <span class="c1">// &#39;answer&#39; can be named anything </span>
...
<span class="nx">logIt</span><span class="p">(</span><span class="s2">&quot;Hello, Students!&quot;</span><span class="p">);</span>  <span class="c1">// less typing needed, don&#39;t need to retype console.log every time</span>
...
<span class="p">}</span>
<span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="s2">&quot;Strings, integers, and arrays&quot;</span><span class="p">)</span>
<span class="nx">logItType</span><span class="p">(</span><span class="s2">&quot;APCSP&quot;</span><span class="p">);</span> <span class="c1">// String</span>
<span class="nx">logItType</span><span class="p">(</span><span class="mf">20</span> <span class="o">/</span> <span class="mf">2</span><span class="p">);</span>    <span class="c1">// Number</span>
<span class="nx">logItType</span><span class="p">([</span><span class="s2">&quot;Kaylee&quot;</span><span class="p">,</span> <span class="s2">&quot;Trey&quot;</span><span class="p">,</span> <span class="s2">&quot;Ben&quot;</span><span class="p">,</span> <span class="s2">&quot;Nico&quot;</span><span class="p">]);</span>  <span class="c1">// Object is generic for this Array, which similar to Python List</span>
</pre></div>
...
<div class="output_subarea output_stream output_stdout output_text">
<pre>Strings, integers, and arrays
string ; APCSP
number ; 10
object ; [ &#39;Kaylee&#39;, &#39;Trey&#39;, &#39;Ben&#39;, &#39;Nico&#39; ]
</pre>
</div>
</div>
...
<span class="kd">var</span> <span class="nx">students</span> <span class="o">=</span> <span class="p">[</span> 
    <span class="k">new</span> <span class="nx">Person</span><span class="p">(</span><span class="s2">&quot;Kaylee&quot;</span><span class="p">,</span> <span class="s2">&quot;kayleehou&quot;</span><span class="p">,</span> <span class="mf">2023</span><span class="p">),</span>
    <span class="k">new</span> <span class="nx">Person</span><span class="p">(</span><span class="s2">&quot;Ben&quot;</span><span class="p">,</span> <span class="s2">&quot;benjaminlee24&quot;</span><span class="p">,</span> <span class="mf">2023</span><span class="p">),</span>
    <span class="k">new</span> <span class="nx">Person</span><span class="p">(</span><span class="s2">&quot;Trey&quot;</span><span class="p">,</span> <span class="s2">&quot;T-Dev-CCM&quot;</span><span class="p">,</span> <span class="mf">2023</span><span class="p">),</span>
    <span class="k">new</span> <span class="nx">Person</span><span class="p">(</span><span class="s2">&quot;Nico&quot;</span><span class="p">,</span> <span class="s2">&quot;NicolasMosqueda&quot;</span><span class="p">,</span> <span class="mf">2023</span><span class="p">),</span>
<span class="p">];</span>
...
<div class="cell border-box-sizing text_cell rendered"><div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<h3 id="JavaScript-and-Table-formatting-using-toHTML-method">JavaScript and Table formatting using toHTML method<a class="anchor-link" href="#JavaScript-and-Table-formatting-using-toHTML-method"> </a></h3><p>This example builds a <mark>Classroom method _toHTML</mark> which is passed to the IJavaScript interpreter $$.html which renders output similarly to a real website.</p>
<ul>
...
<span class="nx">Classroom</span><span class="p">.</span><span class="nx">prototype</span><span class="p">.</span><span class="nx">_toHtml</span> <span class="o">=</span> <span class="kd">function</span><span class="p">()</span> <span class="p">{</span>
  ...
  <span class="nx">body</span> <span class="o">+=</span> <span class="s2">&quot;&lt;th&gt;&lt;mark&gt;&quot;</span> <span class="o">+</span> <span class="s2">&quot;Name&quot;</span> <span class="o">+</span> <span class="s2">&quot;&lt;/mark&gt;&lt;/th&gt;&quot;</span><span class="p">;</span> <span class="c1">// semi colon after every line </span>
...
<div style='display:inline-block;background:black;border: 2px solid grey;box-shadow: 0.8em 0.4em 0.4em grey;'><table><tr><th><mark>Name</mark></th><th><mark>GitHub ID</mark></th><th><mark>Class of</mark></th><th><mark>Role</mark></th></tr><tr><td>Mr M</td><td>jm1021</td><td>1977</td><td>Teacher</td><tr><tr><td>Kaylee</td><td>kayleehou</td><td>2023</td><td>Student</td><tr><tr><td>Ben</td><td>benjaminlee24</td><td>2023</td><td>Student</td><tr><tr><td>Trey</td><td>T-Dev-CCM</td><td>2023</td><td>Student</td><tr><tr><td>Nico</td><td>NicolasMosqueda</td><td>2023</td><td>Student</td><tr></table></div>
</div>
