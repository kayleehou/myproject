...
title: Python Identifying and Correcting Errors
layout: default
categories: [python]
comments: true 
...
<div class="output_subarea output_stream output_stdout output_text">
<pre>The letter h is the 8 letter in the alphabet
</pre>
</div>
</div>
...
<span class="k">for</span> <span class="n">i</span> <span class="ow">in</span> <span class="n">numbers</span><span class="p">:</span>
    <span class="k">if</span> <span class="p">(</span><span class="n">numbers</span><span class="p">[</span><span class="n">i</span><span class="p">]</span> <span class="o">%</span> <span class="mi">2</span> <span class="o">==</span> <span class="mi">0</span><span class="p">):</span> <span class="c1"># % is modulus that returns remainder</span>
...
<span class="k">for</span> <span class="n">i</span> <span class="ow">in</span> <span class="n">numbers</span><span class="p">:</span>
    <span class="k">if</span> <span class="n">numbers</span><span class="p">[</span><span class="n">i</span><span class="p">]</span> <span class="o">==</span> <span class="mi">0</span><span class="p">:</span>
        <span class="k">pass</span>   <span class="c1"># if it&#39;s zero, do nothing, you can also use continue, if it&#39;s equal to zero, skip to loop and bypass the code and do the same thing</span>
    ...
    <span class="k">elif</span> <span class="n">numbers</span><span class="p">[</span><span class="n">i</span><span class="p">]</span> <span class="o">%</span> <span class="mi">2</span> <span class="o">==</span> <span class="mi">0</span><span class="p">:</span>   <span class="c1"># if it doesn&#39;t do first one, it does this, otherwise, nothing happens</span>
        <span class="n">newNumbers</span><span class="o">.</span><span class="n">append</span><span class="p">(</span><span class="n">numbers</span><span class="p">[</span><span class="n">i</span><span class="p">])</span>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="n">my_Menu</span> <span class="o">=</span>  <span class="p">{</span><span class="s2">&quot;pasta&quot;</span><span class="p">:</span> <span class="mf">7.08</span><span class="p">,</span>
            <span class="s2">&quot;pizza&quot;</span><span class="p">:</span> <span class="mf">11.53</span><span class="p">,</span>
            <span class="s2">&quot;breadstick&quot;</span><span class="p">:</span> <span class="mf">0.99</span><span class="p">,</span>
            <span class="s2">&quot;drink&quot;</span><span class="p">:</span> <span class="mf">1.09</span><span class="p">}</span>  <span class="c1"># define my menu as a dictionary data type, key is the name of food, value is the price </span>

<span class="n">price_total</span> <span class="o">=</span> <span class="mi">0</span>  <span class="c1">#set initial value, default value means function argument will take this value if no argument value is passed during function call</span>

<span class="nb">print</span><span class="p">(</span><span class="s2">&quot;======================&quot;</span><span class="p">)</span> <span class="c1">#print menu decoration line on top</span>
<span class="nb">print</span><span class="p">(</span><span class="s2">&quot;~~~ Kaylee&#39;s Menu ~~~&quot;</span><span class="p">)</span>
<span class="c1"># print a nice menu that allows user to choose from </span>
...
<span class="nb">print</span><span class="p">(</span><span class="s2">&quot;======================&quot;</span><span class="p">)</span> <span class="c1">#print menu decoration line at bottom</span>

<span class="nb">print</span><span class="p">(</span><span class="s2">&quot;Welcome to Kaylee&#39;s Italian Food Truck, what would you like to order from our menu?&quot;</span><span class="p">)</span>
<span class="n">myUserInput</span> <span class="o">=</span> <span class="s2">&quot;pasta&quot;</span>  <span class="c1">#define and set initial value</span>
...
<span class="n">myTotalOrderQuestion</span> <span class="o">=</span> <span class="s2">&quot;How many &quot;</span> <span class="o">+</span> <span class="n">myUserInput</span> <span class="o">+</span> <span class="s2">&quot;s would you like to order?&quot;</span>
<span class="n">myError</span> <span class="o">=</span> <span class="s2">&quot;Sorry, we don&#39;t have &#39;&quot;</span> <span class="o">+</span> <span class="n">myUserInput</span> <span class="o">+</span> <span class="s2">&quot;&#39; in our menu&quot;</span>
<span class="n">totalUserInput</span> <span class="o">=</span> <span class="mi">0</span> <span class="c1">#define variable</span>
...
<span class="k">for</span> <span class="n">x</span><span class="p">,</span><span class="n">y</span> <span class="ow">in</span> <span class="n">my_Menu</span><span class="o">.</span><span class="n">items</span><span class="p">():</span> <span class="c1">#loop through my menu</span>
    <span class="k">if</span> <span class="n">x</span> <span class="o">==</span> <span class="n">myUserInput</span><span class="p">:</span> <span class="c1">#if the user input matches a key in my menu4</span>
        <span class="nb">print</span><span class="p">(</span><span class="s2">&quot;Your order is: &quot;</span><span class="p">,</span><span class="n">x</span><span class="p">,</span><span class="n">y</span><span class="p">)</span> <span class="c1">#then print the key and value </span>
    ...
    <span class="k">else</span><span class="p">:</span>
       ...
       <span class="k">if</span> <span class="n">myCounter</span> <span class="o">==</span> <span class="mi">4</span><span class="p">:</span> <span class="c1"># if loop four times, it means we don&#39;t have the item in the menu </span>
            <span class="nb">print</span><span class="p">(</span><span class="n">myError</span><span class="p">)</span>
<span class="k">if</span> <span class="n">myCounter</span> <span class="o">!=</span> <span class="mi">4</span><span class="p">:</span>   
    <span class="nb">print</span><span class="p">(</span><span class="n">myTotalOrderQuestion</span><span class="p">)</span> 
    <span class="n">totalUserInput</span> <span class="o">=</span> <span class="nb">int</span><span class="p">(</span><span class="nb">input</span><span class="p">())</span>   <span class="c1">#only get user input when you need it, otherwise it will always prompt</span>
    <span class="n">myUserTotal</span> <span class="o">=</span> <span class="s2">&quot;Your total for &quot;</span> <span class="o">+</span> <span class="nb">str</span><span class="p">(</span><span class="n">totalUserInput</span><span class="p">)</span> <span class="o">+</span> <span class="s2">&quot; &quot;</span><span class="o">+</span> <span class="n">x</span> <span class="o">+</span><span class="s2">&quot;(s) is $&quot;</span> <span class="o">+</span> <span class="nb">str</span><span class="p">(</span><span class="n">y</span><span class="o">*</span><span class="n">totalUserInput</span><span class="p">)</span><span class="o">+</span> <span class="s2">&quot;. Enjoy!&quot;</span>
    <span class="k">if</span> <span class="n">totalUserInput</span> <span class="o">&gt;=</span> <span class="mi">1</span><span class="p">:</span>
        <span class="nb">print</span><span class="p">(</span><span class="n">myUserTotal</span><span class="p">)</span>
    <span class="k">else</span><span class="p">:</span>
        <span class="nb">print</span><span class="p">(</span><span class="s2">&quot;Please give a number of at least one.&quot;</span><span class="p">)</span>
