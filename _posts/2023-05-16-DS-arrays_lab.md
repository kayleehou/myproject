...
<span class="k">def</span> <span class="nf">test_matrices</span><span class="p">():</span>
    ...
    <span class="k">for</span> <span class="n">title</span><span class="p">,</span> <span class="n">matrix</span> <span class="ow">in</span> <span class="n">matrices</span><span class="p">:</span>  <span class="c1"># unpack title and matrix as variables</span>
        ...
        <span class="n">print_matrix4</span><span class="p">(</span><span class="n">matrix</span><span class="p">)</span>
...
<div id="060e42a4-39f5-47a6-b86e-d028ea3ed41a"></div>
<div class="output_subarea output_javascript ">
<script type="text/javascript">
var element = $('#060e42a4-39f5-47a6-b86e-d028ea3ed41a');
...
<div class="cell border-box-sizing text_cell rendered"><div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<h2 id="Horizontal-Monkeys-Hacks">Horizontal Monkeys Hacks<a class="anchor-link" href="#Horizontal-Monkeys-Hacks"> </a></h2>
</div>
</div>
</div>
    {% raw %}
...
<span class="k">def</span> <span class="nf">main</span><span class="p">():</span>
    ...
    <span class="n">Blue</span> <span class="o">=</span> <span class="s2">&quot;</span><span class="se">\u001b</span><span class="s2">[34m&quot;</span>
    <span class="n">Magenta</span> <span class="o">=</span> <span class="s2">&quot;</span><span class="se">\u001b</span><span class="s2">[35m&quot;</span>
    <span class="n">Reset</span> <span class="o">=</span> <span class="s2">&quot;</span><span class="se">\u001b</span><span class="s2">[0m&quot;</span>
    ...
    <span class="sd">&quot;&quot;&quot; 2D array program logic &quot;&quot;&quot;</span>
    <span class="c1"># cycles through 2D array forwards</span>
    <span class="k">for</span> <span class="n">i</span> <span class="ow">in</span> <span class="nb">range</span><span class="p">(</span><span class="nb">len</span><span class="p">(</span><span class="n">monkeys</span><span class="p">)</span> <span class="o">+</span> <span class="mi">1</span><span class="p">):</span>
        <span class="n">clear_output</span><span class="p">(</span><span class="n">wait</span><span class="o">=</span><span class="kc">True</span><span class="p">)</span>
        ...
        <span class="c1"># this print statement shows current count of Monkeys</span>
        <span class="c1"># concatenation (+) of the loop variable and string to form a countdown message</span>
        <span class="nb">print</span><span class="p">(</span><span class="nb">str</span><span class="p">(</span><span class="nb">len</span><span class="p">(</span><span class="n">monkeys</span><span class="p">)</span> <span class="o">-</span> <span class="n">i</span><span class="p">)</span> <span class="o">+</span> <span class="s2">&quot; little monkeys jumping on the bed. One fell off and bumped his head, how many monkeys jumping on the bed? &quot;</span><span class="p">)</span>

        <span class="c1"># empty string for each part of the monkey</span>
        <span class="n">eyes</span> <span class="o">=</span> <span class="s2">&quot;&quot;</span>
        <span class="n">chin</span> <span class="o">=</span> <span class="s2">&quot;&quot;</span>
        <span class="n">body</span> <span class="o">=</span> <span class="s2">&quot;&quot;</span>
        <span class="n">legs</span> <span class="o">=</span> <span class="s2">&quot;&quot;</span>

        <span class="c1"># iterate through monkeys from the current index to the end</span>
        <span class="k">for</span> <span class="n">row</span> <span class="ow">in</span> <span class="nb">range</span><span class="p">(</span><span class="n">i</span><span class="p">,</span> <span class="nb">len</span><span class="p">(</span><span class="n">monkeys</span><span class="p">)):</span>
            <span class="c1"># concatenate each part of the monkey horizontally with the respective color code</span>
            <span class="n">eyes</span> <span class="o">+=</span> <span class="n">monkeys</span><span class="p">[</span><span class="n">row</span><span class="p">][</span><span class="mi">0</span><span class="p">]</span> <span class="o">+</span> <span class="n">monkeys</span><span class="p">[</span><span class="n">row</span><span class="p">][</span><span class="mi">1</span><span class="p">]</span>
            <span class="n">chin</span> <span class="o">+=</span> <span class="n">monkeys</span><span class="p">[</span><span class="n">row</span><span class="p">][</span><span class="mi">0</span><span class="p">]</span> <span class="o">+</span> <span class="n">monkeys</span><span class="p">[</span><span class="n">row</span><span class="p">][</span><span class="mi">2</span><span class="p">]</span>
            <span class="n">body</span> <span class="o">+=</span> <span class="n">monkeys</span><span class="p">[</span><span class="n">row</span><span class="p">][</span><span class="mi">0</span><span class="p">]</span> <span class="o">+</span> <span class="n">monkeys</span><span class="p">[</span><span class="n">row</span><span class="p">][</span><span class="mi">3</span><span class="p">]</span>
            <span class="n">legs</span> <span class="o">+=</span> <span class="n">monkeys</span><span class="p">[</span><span class="n">row</span><span class="p">][</span><span class="mi">0</span><span class="p">]</span> <span class="o">+</span> <span class="n">monkeys</span><span class="p">[</span><span class="n">row</span><span class="p">][</span><span class="mi">4</span><span class="p">]</span>

        <span class="c1"># print each part of the monkey with its respective color</span>
        <span class="nb">print</span><span class="p">(</span><span class="n">eyes</span> <span class="o">+</span> <span class="n">Reset</span><span class="p">)</span>  <span class="c1"># reset color</span>
        <span class="nb">print</span><span class="p">(</span><span class="n">chin</span> <span class="o">+</span> <span class="n">Reset</span><span class="p">)</span>  <span class="c1"># reset color</span>
        <span class="nb">print</span><span class="p">(</span><span class="n">body</span> <span class="o">+</span> <span class="n">Reset</span><span class="p">)</span>  <span class="c1"># reset color</span>
        <span class="nb">print</span><span class="p">(</span><span class="n">legs</span> <span class="o">+</span> <span class="n">Reset</span><span class="p">)</span>  <span class="c1"># reset color</span>

        <span class="c1"># this new line gives separation between stanzas of the poem</span>
        <span class="nb">print</span><span class="p">()</span>
...
<span class="k">def</span> <span class="nf">bunny_animation</span><span class="p">():</span>
...
<span class="sd">        &quot;&quot;&quot;</span>
    ...
    <span class="k">for</span> <span class="n">i</span> <span class="ow">in</span> <span class="nb">range</span><span class="p">(</span><span class="mi">3</span><span class="p">):</span> <span class="c1"># iterates the frames 3 times </span>
        <span class="k">for</span> <span class="n">frame</span> <span class="ow">in</span> <span class="n">frames</span><span class="p">:</span>
            <span class="n">clear_output</span><span class="p">(</span><span class="n">wait</span><span class="o">=</span><span class="kc">True</span><span class="p">)</span> <span class="c1"># each frame displayed separately without cluttering console </span>
            <span class="nb">print</span><span class="p">(</span><span class="n">frame</span><span class="p">)</span>
            <span class="n">time</span><span class="o">.</span><span class="n">sleep</span><span class="p">(</span><span class="mf">0.2</span><span class="p">)</span> <span class="c1"># pause execution for .2 seconds </span>

<span class="n">bunny_animation</span><span class="p">()</span>
</pre></div>
